      ...
      <div class="ResumeContextDiv">
        ...
        <el-dialog
          ...
          width="750px">
            ...
            <label style="margin-right:1%;margin-left:1%">姓名:</label>
            <el-input
            ...
            <div>&nbsp;</div>
            <label style="margin-right:1%;margin-left:-3%">出生日期:</label>
            <el-date-picker
            ...
            <div>&nbsp;</div>
            <label style="margin-right:1%;margin-left:1%">学历:</label>
            ...
            <div>&nbsp;</div>
            <label style="margin-left:-3.5%;margin-right:1%">手机/微信:</label>
            <el-input
...
<style scoped>
@import '../../../styles/management-page/static-template/UserResume.css'
</style>
